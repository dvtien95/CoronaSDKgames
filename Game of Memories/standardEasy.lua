...
function scene:create( event )
  ...
  local background = display.newImageRect(sceneGroup, "kitchenBG.jpg", 480, 320)
  ...
  local cardSheet = graphics.newImageSheet("standardEasyCard.png", sheetOption)
  
  local sheetFoodOption = 
  {
    frames = 
    {
      {
  ...
  local foodSheet = graphics.newImageSheet("foodSprite.png", sheetFoodOption)
  ...
  for i = 1, numOfCards, 1 do
    ...
    local tmpImage = display.newImageRect(sceneGroup, foodSheet, assignTable[i], xSize*5/8, ySize*5/8)
  ...
  --musicTrack = audio.loadStream( "standardEasy.mp3" )
end
