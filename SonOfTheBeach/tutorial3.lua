...
local function goToNextTutorial( event )
  composer.removeScene("tutorial4")
  composer.gotoScene("tutorial4", { time=400, effect="fromRight" } )
end

local function goToPreviousTutorial( event )
  composer.removeScene("tutorial2")
  composer.gotoScene("tutorial2", { time=400, effect="fromLeft" } )
end
-- -----------------------------------------------------------------------------------
...
function scene:create( event )
  ...
  background = display.newImageRect(sceneGroup, "tutorial3.jpg", 480, 270)
  background.x = 240
  background.y = 180
