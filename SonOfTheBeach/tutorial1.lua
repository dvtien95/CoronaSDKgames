...
local background    local skipButton    local nextButton    local skipText
...
local function goToNextTutorial( event )
  ...
  composer.gotoScene("tutorial2", { time=400, effect="fromRight" } )
end
...
function scene:create( event )
  ...
  background = display.newImageRect(sceneGroup, "tutorial1.jpg", 480, 270)
  background.x = 240
  background.y = 180
